...
export default function Profile() {
  ...
  return (
    <div>
      ...
      <br />
      <div className='softcopy' style={{ backgroundColor: '#E6F2F8', height: 190 }}>
        <div className='container-fluid'>
          <div className='row'>
            <center><h3><button className='btn text-white' style={{ backgroundColor: '#0077b3', marginTop: 30, marginBottom: 20 }}>View Engineering Notes</button></h3></center><br /><br /><br />
            <div className='col-md-3'><center>Civil Engineering</center></div>
            <div className='col-md-3'><center>Computer Engineering</center></div>
            <div className='col-md-3'><center>IT Engineering</center></div>
            <div className='col-md-3'><center>Arcitecture</center></div>
          </div>
        </div></div>
