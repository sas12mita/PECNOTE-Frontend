...
export default function ComNotes() {
      ...
      <div className='container-fluid'>
        <div className='row'>
          ...
          <div className='col-md-8'>
            <br />
            <div>
              <h3>Computer Engineering Notes</h3>
              <br />
              ...
              <table className="table table-striped table-bordered">
                ...
                <tbody>
                  {notes && notes.map((note, index) => {
                    if (note.faculty === 'computer'&& note.semester==='I') {
                      return (
                        <tr key={index}>
              ...
              <table className="table table-striped table-bordered">
                ...
                <tbody>
                  {notes && notes.map((note, index) => {
                    if (note.faculty === 'computer'&& note.semester==='II') {
                      return (
                        <tr key={index}>
                          <td>{note.subjectCode}</td>
                          <td>{note.subjectName}</td>
              ...
              <table className="table table-striped table-bordered">
                ...
                <tbody>
                  {notes && notes.map((note, index) => {
                    if (note.faculty === 'computer'&& note.semester==='III') {
                      return (
                        <tr key={index}>
                          <td>{note.subjectCode}</td>
                          <td>{note.subjectName}</td>
              ...
              <table className="table table-striped table-bordered">
                ...
                <tbody>
                  {notes && notes.map((note, index) => {
                    if (note.faculty === 'computer'&& note.semester==='V') {
                      return (
                        <tr key={index}>
                          <td>{note.subjectCode}</td>
                          <td>{note.subjectName}</td>
              ...
              <table className="table table-striped table-bordered">
                ...
                <tbody>
                  {notes && notes.map((note, index) => {
                    if (note.faculty === 'computer'&& note.semester==='VI') {
                      return (
                        <tr key={index}>
                          <td>{note.subjectCode}</td>
                          <td>{note.subjectName}</td>
              ...
              <table className="table table-striped table-bordered">
                ...
                <tbody>
                  {notes && notes.map((note, index) => {
                    if (note.faculty === 'computer'&& note.semester==='VII') {
                      return (
                        <tr key={index}>
                          <td>{note.subjectCode}</td>
                          <td>{note.subjectName}</td>
              ...
              <table className="table table-striped table-bordered">
                ...
                <tbody>
                  {notes && notes.map((note, index) => {
                    if (note.faculty === 'computer'&& note.semester==='VIII') {
                      return (
                        <tr key={index}>
                          <td>{note.subjectCode}</td>
                          <td>{note.subjectName}</td>
